...
being used in the literature and in computational tools. The various
versions can be quite different and it is important to be aware of the
...
You can also find an extensive discussion about the scattering matrix
and it's normalization in the [[http://www.ita.uni-heidelberg.de/~dullemond/software/radmc-3d/guide.html][RADMC-3D manual]].
