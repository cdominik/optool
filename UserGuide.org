...
the /Simple Icy Grain Model for Aggregates/[fn:1], by Lefévre et
al. (2020).
...
- [[https://www.researchgate.net/profile/Charlene_Lefevre][Charléne Lefévre]] for [[https://github.com/charlenelefevre/SIGMA][SIGMA]], from which suggested to use the
  Maxwell-Garnett rule to add an ice mentle to particles.
