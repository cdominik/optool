...
the opacities into FITS files instead of ASCII, then use one or more
of these parameters during compilation:

# , or if you do not have working OpenMP installation and need to turn
