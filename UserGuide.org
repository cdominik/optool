...
new session, because of the =read=True= flag, if the directories still
...
import optool
import numpy as np
sil  = optool.particle('optool -d -a 0.001 100 0 100 ol-mg50','sil',read=True)
carb = optool.particle('optool -d -a 0.001 3.0 0 50  c','carb',read=True)
#+end_src
