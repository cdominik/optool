...
and Linux at [[https://staff.fnwi.uva.nl/c.dominik/optool][my homepage]]. For shell command line completion support,
check the file =optool-complete=.
