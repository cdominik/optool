...
+ =[-c] MATERIAL [MFRAC]= ::
  ...
  [[#builtin-materials][key for a builtin material]], the [[#lnk-files][path to an =lnk= file]], or three
  colon-separated numbers =n:k:rho= specifying the refractive index
  =n+ik= and the material density =rho= in g/cm^3 directly. =MFRAC= is
  ...
  through the porosity. *-c* is optional except for =n:k:rho=
  materials.
