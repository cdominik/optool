...
cores for speed, or to be able to write FITS files[fn:2], use one or
more of the following parameters during compilation:
...
#+CAPTION: Screenshot of the plots created by running =ipython -i optool_plot.py=.
