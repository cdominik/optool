...
directory for additional information about these materials.
...
|----------+------------+-------------------------+---------+--------+-------------+-------------+--------------+--------------+--------------------------------|
| ice,h2o  | h2o-w      | Water ice               | cryst   |   0.92 |        0.04 |         2e6 | [[https://ui.adsabs.harvard.edu/abs/2008JGRD..11314220W][Warren+08]]    |              | [[file:lnk_data/h2o-w-Warren2008.lnk][h2o-w-Warren2008.lnk]]           |
| co2      | co2-w      | CO_2 ice                | ?       |    1.6 |        0.05 |         2e5 | [[https://ui.adsabs.harvard.edu/abs/1986ApOpt..25.2650W][Warren+86]]    | interpolated | [[file:lnk_data/co2-ice-Warren1986.lnk][co2-ice-Warren2008.lnk]]         |
| nh3      | nh3-m      | NH_3 ice                | ?       |   0.75 |        0.14 |         200 | [[https://ui.adsabs.harvard.edu/abs/1984ApOpt..23..541M][Martonchik83]] | \rho?        | [[file:lnk_data/nh3-m-Martonchik1983.lnk][nh3-m-Martonchik1983.lnk]]       |
...
These are under consideration.  One problem is the limited wavelength
range....
...
- dustkapscatmat.dat ::
  ...
  angular points after the comment section.  This is followed by the
  same block of wavelengths and opacities as described above for the
  =dustkappa.dat= file.  Then follows a list of the grid angles, and
  then the scattering matrix elements for all wavelengths and all
  angles. The comment section at the start of the file explains the
...
[fn:2] This includes a change of the angular grid, and a  change in
the normalization of the scattering matrix.
...
method. By default, it checks the current normalization.  Using
an argument ='r'=, ='b'=, ='m'=, or ='h'=, will modify the
normalization.
