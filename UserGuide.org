...
#+LaTeX: \centerline{by Carsten Dominik, Michiel Min, and Ryo Tazaki; September 2023, version 1.9.14}
...
:END:
** Direct compilation from source code
...
+ =-err= :: Generate exit code 1 on failure.
