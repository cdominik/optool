...
installed, or if you need more speed while using the *-d* switch, you
can do all that with these switches:

: make ifort=true         # compile using the Intel fortran compiler iFort
: make fitsio=true        # add support for writing FITSg files with cfitsio
