...
+ =-mmf [A0 [DFRAC-OR-FILL]]= ::
  ...
  *-m*, and *-p* determine the composition of monomers with radius
  ...
  dimension (if >1) or the /volume filling factor/ (if <1) of the
  aggregates. The default is 0.2, i.e. 20% filling factor.
...
+ =-print [VAR]= ::
  ...
  =kabs=, =ksca=, =kext=, or =g=, write only that quantity.  You can
