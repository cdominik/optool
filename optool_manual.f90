subroutine manual()
  ...
  write(*,'("  session, because of the  cache=True  flag, if the directories still")')
  write(*,'("  exist and were produced using the same commands, the opacities are")')
  write(*,'("  simply read back in.")')
  write(*,'("")')
  write(*,'("  ,----")')
  write(*,'("  | import optool")')
