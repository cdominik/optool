subroutine manual()
  ...
  write(*,'("  -  Python  interface module for easy post-processing and cross-tool")')
  write(*,'("    use.")')
  write(*,'("")')
  write(*,'("")')
  ...
  write(*,'("~~~~~~~~~~~~~~~~")')
  write(*,'("")')
  write(*,'("   op tool  is distributed under the [MIT license] and can be used,")')
  ...
  write(*,'("  even simpler generic key.  Please check the files in the  lnk_data ")')
  write(*,'("  directory for additional information about these materials.  Most of")')
  write(*,'("  the refractive index datasets have a wide wavelength coverage - the")')
  write(*,'("  few exceptions are highlighted by bold-face numbers.  If a material is")')
  write(*,'("  being used outside of the measured region,  optool  will still")')
  write(*,'("  function, using extrapolated optical properties that will be quite")')
  write(*,'("  reasonable in many cases. Of course specific features in these")')
  write(*,'("  unmeasured regions will be missing from the the opacities.")')
  write(*,'("")')
  write(*,'("  *		     Table 1:* Built-in materials")')
  write(*,'("  -c Key    -c Key      Material                 State         rhx   Reference ")')
  write(*,'(" generic   full key                                         g/cm^m             ")')
  write(*,'("-------------------------------------------------------------------------------")')
  write(*,'("           pyr-mg100   MgSiO_3                  amorph        2.70  [Dorschner+")')
  write(*,'("           pyr-mg95    Mg_0.95  Fe_0.05  SiO_3  amorph        2.70  [Dorschner+")')
  write(*,'("           pyr-mg80    Mg_0.8  Fe_0.2  SiO_3    amorph         2.0  [Dorschner+")')
  write(*,'(" pyr       pyr-mg70    Mg_0.7  Fe_0.3  SiO_3    amorph        3.00  [Dorschner+")')
  write(*,'("           pyr-mg60    Mg_0.6  Fe_0.4  SiO_3    amorph         3.0  [Dorschner+")')
  write(*,'("           pyr-mg50    Mg_0.5  Fe_0.5  SiO_3    amorph         3.0  [Dorschner+")')
  write(*,'("           pyr-mg40    Mg_0.4  Fe_0.6  SiO_3    amorph         3.0  [Dorschner+")')
  write(*,'(" ens       pyr-c-mg96  Mg_0.96  Fe_0.04  SiO3   cryst          2.   [Jäger+98]")')
  write(*,'("-------------------------------------------------------------------------------")')
  write(*,'(" ol        ol-mg50     MgFeSiO_4                amorph        3.70  [Dorschner+")')
  write(*,'("           ol-mg40     Mg_0.8 Fe_1.2 SiO_4      amorph        3.70  [Dorschner+")')
  write(*,'(" for       ol-c-mg100  Mg_2 SiO_4               cryst         3.30  [Steyer+74]")')
  write(*,'("-------------------------------------------------------------------------------")')
  write(*,'("           astrosil    MgFeSiO4                 mixed          3.5  [Draine+03]")')
  write(*,'("-------------------------------------------------------------------------------")')
  write(*,'(" c         c-z         C                        amorph?        1.4  [Zubko+96] ")')
  write(*,'("           c-p         C                        amorph         1.0  [Preibisch+")')
  write(*,'(" gra       c-gra       C graphite               cryst        2.160  [Draine+03]")')
  write(*,'(" org       c-org       CHON organics            amorph         1.5  [Henning+96")')
  write(*,'("           c-nano      C nano-diamond           cryst          2.   [Mutschke+0")')
  write(*,'("-------------------------------------------------------------------------------")')
  write(*,'(" iron      fe-c        Fe                       metal         7.85  [Henning+96")')
  write(*,'("           fes         FeS                      metal         4.85  [Henning+96")')
  write(*,'("           sic         SiC                      cryst         3.20  [Laor93]   ")')
  write(*,'("-------------------------------------------------------------------------------")')
  write(*,'(" cor       cor-c       Al_2  O_3                cryst          4.   [Koike+95] ")')
  write(*,'("-------------------------------------------------------------------------------")')
  write(*,'(" h2o       h2o-w       Water ice                cryst         0.96  [Warren+08]")')
  write(*,'(" co2       co2-w       CO_2 ice                 cryst          1.5  [Warren+86]")')
  write(*,'(" nh3       nh3-m       NH_3 ice                 cryst         0.70  [Martonchik")')
  write(*,'(" co        co-a        CO                       amorph        0.8   [Palumbo+06")')
  write(*,'("           co2-a/c     CO_2                     am/cr          1.   [Gerakines+")')
  write(*,'("           ch4-a/c     CH_4                     am/cr         0.4   [Gerakines+")')
  write(*,'("           ch3oh-a/c   CH_3  OH                 am/cr    0.78/1.0   [Gerakines+")')
  write(*,'("")')
  write(*,'("")')
  write(*,'("")')
  ...
  write(*,'("    $n_\lambda$ and the specific density rho of the material in g/cm^3")')
  ...
  write(*,'("    The mean opacities are per unit of grain mass, so the dust-to-gas")')
  write(*,'("    mass ratio would still have to be applied to obtain opacities for a")')
  write(*,'("    gas-dust mixture.")')
  write(*,'("")')
  write(*,'("  Other functionality in the python model includes reading and writing")')
  write(*,'("   lnk  files and constructing opacities for a mix of different grain")')
  write(*,'("  species.  For more information, please read the documentation inside")')
  write(*,'("  the file  optool.py .")')
  write(*,'("")')
  write(*,'("")')
  write(*,'("")')
  write(*,'("8 Units")')
  ...
  write(*,'("")')
  write(*,'("")')
  write(*,'("10 How to ingest refractive index data for another material")')
  write(*,'("===========================================================")')
  write(*,'("")')
  ...
  write(*,'("  - [Klaus van Pontoppidan] for unpublished refractive index data of the")')
  write(*,'("    c2d ice mix.")')
  write(*,'("")')
  write(*,'("")')
  write(*,'("")')
