subroutine manual()
  ...
  write(*,'("   optool  can also produce output for [RADMC-3D] which uses")')
  write(*,'("")')
  write(*,'("  \begin{equation}")')
  write(*,'("  \label{eq:2}")')
  ...
  write(*,'("  normalizations again. As explained in RADMC-3D s manual, these")')
  ...
  write(*,'("~~~~~~~~~~~~~~~~~~~~~~~~~~~")')
  write(*,'("")')
  write(*,'("  For a comparison with a simple Mie code like BHMIE, turn off DHS and")')
