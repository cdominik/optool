subroutine manual()
  ...
  write(*,'("")')
  write(*,'("")')
  write(*,'("		       April 2021, version 1.8.1")')
  write(*,'("")')
  write(*,'("")')
  write(*,'("")')
  write(*,'("")')
  ...
  write(*,'("      -------+-----------------------+-----------------------+-----------------")')
  write(*,'("       $f$   | $N^(D_\rm f  -3)/3  $ |  given by user        | $\3/D_\rm f    N")')
  write(*,'("       $D_f$ |  given by user        | $3\ln N\,/\,\ln(N/f)$ |  g              ")')
  write(*,'("       $k_f$ | $(5/3)^D_\rm f  /2  $ | $(5/3)^D_\rm f  /2  $ |  g              ")')
  write(*,'("")')
