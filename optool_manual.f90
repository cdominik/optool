subroutine manual()
  ...
  write(*,'("  as in [OpacityTool]. In  optool , I focused on the user interface,")')
  write(*,'("  ease of use, and a clean set of conventions. As a reference for this")')
  write(*,'("  tool, please point to the [GitHub repository]. If you use it to")')
  write(*,'("  publish papers, cite the papers establishing the methods used, as well")')
  write(*,'("  as to the original laboratory papers that published the refractive")')
  write(*,'("  index measurements.")')
  write(*,'("")')
  ...
  write(*,'("")')
  write(*,'("  ,----")')
  write(*,'("  | optool ice -a 1 3 2.5 15  -l 10 100")')
  write(*,'("   ----")')
  write(*,'("")')
  ...
  write(*,'("")')
  write(*,'("   -b ")')
  write(*,'("          Only blend the materials and write the output to")')
  write(*,'("           blended.lnk .")')
  write(*,'("")')
  write(*,'("   -q ")')
