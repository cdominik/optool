subroutine manual()
  ...
  write(*,'("")')
  write(*,'("  However, RADMC-3D requires the values of the scattering matrix on the")')
  write(*,'("  cell /boundaries/, so at 0degree, 1degree etc to 180degree, for a")')
  write(*,'("  total of 181 values.  For the input files for RADMC-3D, we interpolate")')
  write(*,'("  and extend the computed values to the cell boundaries.")')
  write(*,'("")')
  write(*,'("")')
