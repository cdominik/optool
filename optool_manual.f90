subroutine manual()
  ...
  write(*,'("")')
  write(*,'("")')
  write(*,'("		       March 2021, version 1.7.2")')
  write(*,'("")')
  write(*,'("")')
  write(*,'("")')
  write(*,'("")')
  ...
  write(*,'("  string like  pyr-mg70 . In each material class I have selected a")')
  write(*,'("  useful default, accessible with an even simpler generic key.  Please")')
  write(*,'("  check the files in the  lnk_data  directory for additional information")')
  write(*,'("  about these materials.  Most of the refractive index datasets have a")')
  write(*,'("  wide wavelength coverage - the few exceptions are highlighted by")')
  write(*,'("  bold-face numbers.  If a material is being used outside of the")')
  write(*,'("  measured region,  optool  will still function, using extrapolated")')
  write(*,'("  optical properties that will be quite reasonable in many cases. Of")')
  write(*,'("  course specific features in these unmeasured regions will be missing")')
  write(*,'("  from the the opacities.")')
  write(*,'("")')
  ...
  write(*,'("  with factors and adding them), for example to produce opacites for a")')
  write(*,'("  mixture of different grains or scale opacities using a dust-to-gas")')
  write(*,'("  ratio:")')
  write(*,'("")')
  write(*,'("  ,----")')
