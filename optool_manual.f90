subroutine manual()
  ...
  write(*,'("")')
  write(*,'("  - *optool:* [Dominik, C., Min, M. & Tanaka, R. 2021, Optool, 1.9,")')
  ...
  write(*,'("        [forward scattering peak] and compensate by a reduction of the")')
  ...
  write(*,'("        interpreted as the /compact/[5] size of all material in the")')
  ...
  write(*,'("    ([available on github]).  Also, it was his idea to include something")')
  write(*,'("    like  optool2tex .")')
