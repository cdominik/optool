subroutine manual()
  ...
  write(*,'("")')
  write(*,'("		     Carsten Dominik & Michiel Min")')
  write(*,'("		    _______________________________")')
  write(*,'("")')
  write(*,'("")')
  write(*,'("			July 2020, version 0.9.8")')
  write(*,'("")')
  write(*,'("")')
  write(*,'("")')
  write(*,'("")')
  ...
  write(*,'("  command line. It is derived[1] from Michiel Min s [OpacityTool] for")')
  write(*,'("  the [DIANA] program, and committed to its simplicity.")')
  write(*,'("")')
  write(*,'("")')
  write(*,'("Capabilities")')
  write(*,'("~~~~~~~~~~~~")')
  ...
  write(*,'("")')
  write(*,'("  ,----")')
  write(*,'("  | optool pyr-mg70 0.87  c 0.13  -p 0.25  -m lnkfiles/ice_hudgins.dat 0.2")')
  write(*,'("   ----")')
  write(*,'("")')
  ...
  write(*,'("")')
  write(*,'("  ,----")')
  write(*,'("  | optool ice 1.0  -a 1 3 2.5 15  -l 10 100")')
  write(*,'("   ----")')
  write(*,'("")')
  ...
  write(*,'("  orientations of a crystaline material into a file  blended.lnk , using")')
  write(*,'("  the wavelength grid given in one of those files")')
  write(*,'("")')
  write(*,'("  ,----")')
  ...
  write(*,'("        *-m* options).")')
  write(*,'("")')
  write(*,'("   [-c] KEY-or-FILE1 [MFRAC] [KEY-or-FILE2 [MFRAC]] ... ")')
  ...
  write(*,'("        can give up to 10 materials to build up the grain.  All")')
  write(*,'("        materials will be mixed together using the Bruggeman rule, and")')
  write(*,'("        vacuum can be included through the porosity. A *-c* switch")')
  write(*,'("        before each  KEY-or-FILE  is optional.")')
  write(*,'("")')
  ...
  write(*,'("")')
  write(*,'("   -b ")')
  write(*,'("          Only blend the materials using the Bruggeman rule and write")')
  write(*,'("        the output to  blended.lnk .")')
  write(*,'("")')
  write(*,'("   -q ")')
  write(*,'("          Quiet. Reduce the amount of text written to STDOUT to a")')
  write(*,'("          minimum.")')
  write(*,'("")')
  write(*,'("")')
  ...
  write(*,'("  So for the input files for RADMC-3D, we interpolate and extend the")')
