subroutine manual(what)
  ...
  if (what.eq.'all') then
     ...
     write(*,'("==============")')
     write(*,'("")')
     write(*,'("  You can download and compile  optool  with these simple steps, using")')
     write(*,'("  the freely available GNU FORTRAN compiler [ gfortran ].")')
     write(*,'("")')
     write(*,'("  ,----")')
     ...
     write(*,'("  shell command line completion support, check the file")')
