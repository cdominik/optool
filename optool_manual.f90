subroutine manual()
  ...
  write(*,'("  directory for additional information about these materials.  Most")')
  write(*,'("  material have a wide wavelengths range. The few exceptions are")')
  write(*,'("  highlighted by bold-face numbers.")')
  write(*,'("")')
