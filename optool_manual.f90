subroutine manual()
  ...
  write(*,'("")')
  write(*,'("")')
  write(*,'("		       April 2021, version 1.8.2")')
  write(*,'("")')
  write(*,'("")')
  write(*,'("")')
  write(*,'("")')
  ...
  write(*,'("  tool are listed below.  Please point to the GitHub repository and cite")')
  write(*,'("  the papers that are relevant for your use case.")')
  write(*,'("")')
  ...
  write(*,'("-------------------------------------------------------------------------------")')
  write(*,'("             astrosil    MgFeSiO_4                mixed          1e5  [Draine+0")')
  write(*,'("-------------------------------------------------------------------------------")')
  ...
  write(*,'("")')
  write(*,'("  You can find additional refractive index data [here], in databases")')
  write(*,'("  like the [Jena database], and associated with original papers in the")')
  ...
  write(*,'("")')
  write(*,'("        - wavelength in [mum]")')
  write(*,'("        - kappa_ext in, kappa_abs, kappa_sca, all in [cm^2/g]")')
  write(*,'("")')
  ...
  write(*,'("        same command line arguments as used in an  optool  run, to")')
  write(*,'("        produce this file.  It contains a paragraph of text and a table,")')
  write(*,'("        listing the composition of the grains and the computational")')
  write(*,'("        methods, along with proper references, using the BibTeX file")')
  write(*,'("         optool.bib . You can rework this text to include it into your")')
  write(*,'("        paper. For more details, read the comment section in")')
  write(*,'("         optool2tex .")')
  write(*,'("")')
  write(*,'("")')
  write(*,'("")')
  ...
  write(*,'("")')
  write(*,'("  The python module has a few more tricks up its sleeve.  We show a few")')
  write(*,'("  examples here - full documentation is inside the Python module file")')
  write(*,'("   optool.py .")')
  write(*,'("")')
  write(*,'("  - A  lnktable  class to read, plot, modify and write  lnk  files.")')
  write(*,'("    ,----")')
  write(*,'("    | x = optool.lnkfile( lnk_data/sio2-Kitamura2007.lnk )")')
  write(*,'("    | x.plot()")')
  write(*,'("     ----")')
  write(*,'("")')
