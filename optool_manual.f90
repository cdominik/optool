subroutine manual()
  ...
  write(*,'("        any of  kabs ,  ksca ,  kext , or  g , write only that quantity.")')
  write(*,'("        You can use this to extract a single value, for example the")')
  write(*,'("        850mum extinction opacity of grains between 1 and 3mm:  optool")')
  write(*,'("        -a 1000 3000 -l 850 -print kext ")')
  write(*,'("")')
  write(*,'("")')
  write(*,'("")')
  ...
  write(*,'(" for         ol-c-mg100   Mg_2  SiO_4              cryst          200  [Suto+06")')
  write(*,'("             ol-c-mg95    Mg_1.9  Fe_0.1  SiO_4    cryst         8190  [Fabian+")')
  write(*,'(" fay         ol-c-mg00    Fe_2  SiO_4              cryst          250  [Fabian+")')
  write(*,'("-------------------------------------------------------------------------------")')
