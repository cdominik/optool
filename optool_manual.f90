subroutine manual()
  ...
  write(*,'("")')
  write(*,'("")')
  write(*,'("4.1 Grain composition and geometry")')
  write(*,'("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")')
  write(*,'("")')
  write(*,'("   -c ")')
  ...
  write(*,'("")')
  write(*,'("")')
  write(*,'("4.2 Grain size distribution")')
  write(*,'("~~~~~~~~~~~~~~~~~~~~~~~~~~~")')
  write(*,'("")')
  ...
  write(*,'("")')
  write(*,'("")')
  write(*,'("4.4 Controlling the output")')
  write(*,'("~~~~~~~~~~~~~~~~~~~~~~~~~~")')
  write(*,'("")')
  ...
  write(*,'("")')
  write(*,'("")')
  write(*,'("9.2 Scattering Matrix: The fine print")')
  write(*,'("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")')
  write(*,'("")')
  ...
  write(*,'("")')
  write(*,'("")')
  write(*,'("9.3 How to ingest refractive index data for another material")')
  write(*,'("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")')
  write(*,'("")')
  ...
  write(*,'("")')
  write(*,'("")')
  write(*,'("9.4 Comparison with other codes")')
  write(*,'("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")')
  write(*,'("")')
  ...
  write(*,'("        available, the core and the mantle mixtures are put together")')
  write(*,'("        using the Bruggeman rule.  Mass fractions are converted into")')
  write(*,'("        volume fractions, and porosity is implemented using vacuum as an")')
  write(*,'("        additional material.  The subroutine doing the mixing uses an")')
  write(*,'("        iterative procedure that is very stable, also for a large number")')
  write(*,'("        of components.")')
  ...
  write(*,'("        particle.")')
  write(*,'("")')
  write(*,'("  Computational Structure")')
  write(*,'("        The computation of opacities and matrix elements follows this")')
  write(*,'("        structure.  Additional information can be obtained by reading")')
  write(*,'("        the code.")')
  write(*,'("        ,----")')
  write(*,'("        | ,- Loop over all wavelengths lambda")')
  write(*,'("        | |  ,- Loop over all particle sizes a")')
  write(*,'("        | |  |  ,- Loop over all DHS volume ratios f")')
  write(*,'("        | |  |  |   - Call DMiLay or (for large x) MeerhoffMie")')
  write(*,'("        | |  |   - Sum the weighted contributions of each DHS volume")')
  write(*,'("        | |   - Sum weighted contributions of all particle sizes")')
  write(*,'("        |  - Store the results for the current wavelength")')
  write(*,'("         ----")')
  write(*,'("")')
  write(*,'("")')
  write(*,'("10 Bibliography")')
  write(*,'("===============")')
  write(*,'("")')
