subroutine manual(what)
  ...
  if (what.eq.'all') then
     ...
     write(*,'("")')
     write(*,'("  If compiling the code is a problem, you can also find binaries for Mac")')
     write(*,'("  and Linux at [my homepage]. For shell command line completion support,")')
     write(*,'("  check the file  optool-complete .")')
     write(*,'("")')
